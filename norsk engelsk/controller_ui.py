...
class ControllerInput:
    ...
    def build(self, parent):
        ...
        ttk.Button(views, text='Front + shoulders', style='Small.TButton',
                   command=lambda: self.preview.set_view('front')).pack(side='left', padx=4)
        ttk.Button(views, text='Rear paddles', style='Small.TButton',
                   command=lambda: self.preview.set_view('back')).pack(side='left', padx=4)
