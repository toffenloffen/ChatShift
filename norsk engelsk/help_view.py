...
SECTIONS = {'Get started': ('Start here',
                 ...
                 'For a microphone check without a game, open Voice → Speech and translation test → Test translation.\n'
                 '\n'
 ...
 'How to use': ('Text or voice. Your choice.',
                ...
                'Noise suppression is optional and runs locally before speech recognition. '
                'Turn it on under Microphone. Mic Test shows Input before filtering and Output after filtering. '
                'Enable Listen with headphones to hear the result and toggle Noise suppression to compare. '
                'Speech and translation test records a short sentence, then shows what Whisper heard and '
                'the translation after Stop recording. Listen: original and Listen: processed replay the same recording. '
                'It does not identify your voice or guarantee removal of other speakers. '
                'Settings apply to the next recording; turning it off bypasses the filter.\n'
                '\n'
                'WAIT FOR THE RESULT\n'
                ...
                '\n'
                'ChatShift stays visible when it starts. Run in background at the top hides it when you choose. '
                'Pause stops shortcuts. Closing the window '
                'exits it.'),
